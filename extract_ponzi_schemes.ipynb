...
# Create excel sheet for address 
def export_to_excel(address_list): 

    mark_for_df_export = 3000
    batch_number = 1
    ...
    for j in address_list: 
        ...
        if address_list.index(j) == mark_for_df_export: 
            ...
            batch_name = "output" + str(batch_number) + ".xlsx"
...
# # Testing function
# address = "16LspDcuuAk3rZL5rf5Rtmcm75fYMGaeo4"
# address_list = []
# address_list.append("19TWwMYNDf4vdzud6KH8twHJeJ5P4NjWt6")
# address_list.append(address)
# address_list.append("1B28wFJMraCBPR1ThCAUHjMFq5jFtEaN77")
# export_to_excel(address_list)

# # Getting the information we need for ponzi addresses here

df_ponzi = pd.read_excel("full_list_of_ponzi_schemes.xlsx")
full_list_of_address = list(df_ponzi['transaction_address']) 
export_to_excel(full_list_of_address)
print("export completed")

# Check that our excel import worked
# print(full_list_of_address)